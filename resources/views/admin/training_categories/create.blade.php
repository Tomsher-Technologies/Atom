@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Create Training Category'])
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Create Training Category</h1>
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.training.category-store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Home Page Icon <span class="text-info">(Please upload an image with size less than 50 KB and dimensions 66x66 pixels)</span></label>
                                <div class="input-group mb-3">
                                    <div class="custom-file">
