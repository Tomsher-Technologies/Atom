@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Edit accreditations Details'])
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Edit accreditations Details</h1>
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('admin.accreditations.update', [
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="link" class="form-control" value="{{ old('link', $accreditation->link) }}">
                            ...
                            <div class="form-group">
                                ...
                                <img class="w-100" src="{{ $accreditation->getImage() }}" alt="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control select2-single mb-3">
                                    <option {{ old('status', $accreditation->status) == '1' ? 'selected' : '' }} value="1">
                                        Enabled
                                    </option>
                                    <option {{ old('status', $accreditation->status) == '0' ? 'selected' : '' }} value="0">
                                        Disabled
                                    </option>
                                </select>
                            ...
                            <a href="{{ route('admin.accreditations.index') }}" class="btn btn-info mb-0"> Cancel</a>
                ...
                <form id="deleteForm" method="POST"
                    action="{{ route('admin.accreditations.destroy', [
                        'accreditation' => $accreditation,
                    ]) }}"
                    enctype="multipart/form-data">
                    @csrf
