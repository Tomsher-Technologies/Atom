@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Edit Training Course'])
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" class="repeater" id="addCourse" action="{{ route('admin.training.course-update', [
                            'course' => $course->id,
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" class="form-control" >
                                    ...
                                    @foreach ($categories as $cat)
                                        <option {{ (old('category', $course->category_id) == $cat->id) ? 'selected' : '' }} value="{{ $cat->id }}">{{$cat->name}} </option>
                                    @endforeach
                                </select>
                                <x-input-error name='name' />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img class="w-100" src="{{ $course->getBannerImage() }}" alt="">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Banner Title</label>
                                <input type="text" name="banner_title" class="form-control" value="{{ old('banner_title', $course->banner_title) }}">
                            ...
                            <div class="form-group">
                                <div class="textarea-group">
                                    ...
                                    <textarea class="form-control" id="bannerEditor" name="banner_description" rows="2">{{old('banner_description', $course->banner_content)}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="descEditor" name="course_description" rows="2">{{old('course_description', $course->description)}}</textarea>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Current Course Image</label>
                                <img class="w-100" src="{{ $course->getCourseImage() }}" alt="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="language" class="form-control" >
                                    ...
                                    @foreach ($languages as $lang)
                                        <option {{ (old('language', $course->lang_id) == $lang->id) ? 'selected' : '' }} value="{{ $lang->id }}">{{$lang->title}} </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="course_type" class="form-control" >
                                    ...
                                    @foreach ($course_types as $type)
                                        <option {{ (old('course_type', $course->course_type_id) == $type->id) ? 'selected' : '' }} value="{{ $type->id }}">{{$type->title}} </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="location" id="location" class="form-control " >
                                    <option value="{{$course->location_id}}" >{{$course->location->name ?? ''}} </option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="sort_order" id="sort_order" class="form-control" value="{{ old('sort_order', $course->sort_order) }}">
                            ...
                            <a href="{{ route('admin.training.courses') }}" class="btn btn-info mb-0"> Cancel</a>
                        </form>
                    </div>
                </div>
...
@push('footer')
    ...
    <script>
        ...
        repeater.setList(course_details);
