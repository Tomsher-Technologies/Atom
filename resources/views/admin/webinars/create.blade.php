@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Create Webinar'])
@section('content')
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.webinars.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group position-relative error-l-50">
                                ...
                                <textarea class="form-control" id="engEditor" name="description" rows="2">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="webinar_date" id="webinar_date" class="form-control" value="{{ old('webinar_date') }}" autocomplete="off">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Title</label>
                                <input type="text" name="presented_title" class="form-control" value="{{ old('presented_title') }}">
                                <x-input-error name='presented_title' />
                            </div>

                            <div class="form-group position-relative error-l-50">
                                <label>Position/Designation</label>
                                <input type="text" name="presented_description" class="form-control" value="{{ old('presented_description') }}">
