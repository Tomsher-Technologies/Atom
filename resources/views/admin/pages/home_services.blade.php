@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Home - Services Page Contents'])
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Home - Services Page Contents</h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" class="repeater"
                            action="{{ route('admin.page.store-home-services', [
