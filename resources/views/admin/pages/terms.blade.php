@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Terms & Conditions Page Contents'])
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Terms & Conditions Page Contents</h1>
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('admin.page.store-terms', [
                                'page_name' => 'terms',
                            ]) }}"
