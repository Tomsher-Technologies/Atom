@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Webinars Page Contents'])
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Webinars Page Contents</h1>
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('admin.page.store-webinars', [
                                'page_name' => 'webinars',
                            ]) }}"
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Upcoming Heading</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Upcoming Content</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Completed Heading</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Completed Content</label>
