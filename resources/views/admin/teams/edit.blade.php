@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Edit teams Details'])
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Edit Teams Details</h1>
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('admin.teams.update', [
                                'team' => $team,
                            ]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <img class="w-100" src="{{ $team->getImage() }}" alt="">
                            </div>
                            ...
                            <a href="{{ route('admin.teams.index') }}" class="btn btn-info mb-0"> Cancel</a>
